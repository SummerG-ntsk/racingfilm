...
export const siteConfig: SiteConfig = {
	// 站点标题
	title: "LIFEINTHEFASTLANE",

	// 站点副标题
	subtitle: "Racing Film Festival",

	// 站点 URL
	site_url: "https://lifeinthefastlane.filmfestival.cn",

	// 站点描述
	description:
		"Note: This website is a student project created for academic purposes only.",
